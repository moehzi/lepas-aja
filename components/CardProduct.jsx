  ...
  return (
    <div className="max-w-[250px] rounded-lg shadow-lg  bg-[#F0F0F0] group relative overflow-hidden">
      <Link href={`/giveaway/${props.id}`}>
        <a>
          <img src={props.src} alt={props.name} className="object-cover w-full rounded-t-lg h-60" />
          <div className="invisible group-hover:visible absolute bottom-0 left-0 w-full px-6 py-4 group-hover:bg-[#DC2F2F] transition ease-in duration-150">
